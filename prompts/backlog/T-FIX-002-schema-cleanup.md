# T-FIX-002 · Correcciones técnicas del schema (Bolsa C)

**Ticket Jira:** https://tu-org.atlassian.net/browse/T-FIX-002
**Agente asignado:** A1 (Arquitecto NestJS)
**Supervisor humano:** S1
**Sprint:** Sprint 2 (no bloquea Sprint 1)
**Estimación:** 5 puntos
**Prioridad:** media
**Rama:** `fix/T-FIX-002-schema-cleanup`
...
```bash
git checkout -b fix/T-FIX-002-schema-cleanup
claude
```
...
```
Ejecuta T-FIX-002 (correcciones técnicas del schema).

Actúas como agente A1. Lee en orden:
1. @CLAUDE.md
2. @agents/A1-nestjs.md
3. @prompts/backlog/T-FIX-002-schema-cleanup.md
